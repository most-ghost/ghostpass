# These are yoinked out of https://github.com/pythonguis/python-qtwidgets/. I collected the few 
...
class PasswordEdit(QtWidgets.QLineEdit):
    ...
    def __init__(self, show_visibility=True, *args, **kwargs):
        ...
        self.visibleIcon = QtGui.QIcon(os.path.join(folder, "hidden.svg"))
        self.hiddenIcon = QtGui.QIcon(os.path.join(folder, "eye.svg"))
